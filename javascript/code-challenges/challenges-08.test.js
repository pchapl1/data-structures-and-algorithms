...
// found the documentation for this here: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/sort
const sortByChildren = (charArray) => {
  characters.sort((a, b) => {
    if (a.children.length < b.children.length) {
      ...
      // if the houses have the same number of children, sort alphabetically by house name
      if (a.house < b.house) {
        return -1;
